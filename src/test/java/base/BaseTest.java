...
import constants.urls.KinoparkUrl;
...
//        driver.get(KinoparkUrl.kinoparkUrl);
//        // Suggested by Mr. Mkrthcyan as the page is loading very slow
//        Thread.sleep(10000);
//    }

    @BeforeMethod
    public void goHome() throws MalformedURLException, InterruptedException {
